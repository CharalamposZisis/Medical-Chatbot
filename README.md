...
I implemented a preprocessing pipeline before storing the data in Pinecone:<br>
    ...
    - I gave the system prompt which was - >  <br>
    system_prompt = ( <br>
    'You are an Medical assistant for question-answering tasks.' <br>
    'Use the following pieces of retrieved context to answer' <br>
    'the question. If you don "t now the answer, say that you' <br>
